				...
				<div className="row g-5 mb-5 footer-g5-width" >
					<div className="col-lg-4">
						...
						<ul className="list-unstyled custom-social">
							<li><a href="#"><SlSocialFacebook size={20}/></a></li>
							<li><a href="#"><RiTwitterXFill size={20}/></a></li>
							<li><a href="#"><LiaInstagram size={20}/></a></li>
							<li><a href="#"><LiaLinkedin size={20}/></a></li>
						</ul>
					</div>
				...
				<div className="border-top copyright">
					<div className="row pt-4">
						<div className="col-lg-6">
							<p className="mb-2 text-center text-lg-start">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Untree.co</a> Distributed By 
