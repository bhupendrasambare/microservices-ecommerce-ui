...
import Cross from 'Frontend/assets/web/cross.svg'
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <p><a onClick={()=>navigate("/shop")} className="btn">Explore</a></p>
                </div> 
                
                <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a className="product-item" onClick={()=>navigate("/cart")}>
                ...
                <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a className="product-item" onClick={()=>navigate("/shop")}>
