...
function Cart() {
  return (
    <div>
        <NavBar/>
        <HeroSection title='Cart' description="" showButton={false}/>
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>$49.00</td>
                          <td>
                            <div className="input-group mb-3 d-flex align-items-center quantity-container max-w-120px" >
                              <div className="input-group-prepend">
                                <button className="btn btn-outline-black decrease" type="button">&minus;</button>
                              </div>
                              <input type="text" className="form-control text-center quantity-amount" value="1" 
