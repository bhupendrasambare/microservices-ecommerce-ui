            ...
            <SidebarComponent>
                <div className="row mt-3">
                    <Row>
                        ...
                        <Col xs={12} sm={6} lg={3} className="mb-4">
                            <DashboardCard theme='success' title="Orders" description="This months earning" value="32K" />
                        </Col>
                        <Col xs={12} sm={6} lg={3} className="mb-4">
                            <DashboardCard theme='danger' title="Reviews" description="Total reviews" value="254" />
                        </Col>
                    </Row>
                </div>
