                ...
                <div className="col-12 col-lg-4 col-xl-3">
                    ...
                    {/* <div className="col-12">
                        ...
                        <div className="card-body">
                            ...
                            <li className="list-group-item">
                                <h6 className="mb-1">
                                <span className="bii bi-building-fill-gear me-2"></span>
                                Company
                                </h6>
                ...
                <div className="col-12 col-lg-8 col-xl-9">
                    ...
                    <div className="card-body p-4">
                        {/* <ul className="nav nav-tabs" id="profileTab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="email-tab" data-bs-toggle="tab" data-bs-target="#email-tab-pane"
                                 type="button" role="tab" aria-controls="email-tab-pane" aria-selected="false">
                                    Emails</button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="password-tab" data-bs-toggle="tab" data-bs-target="#password-tab-pane" 
