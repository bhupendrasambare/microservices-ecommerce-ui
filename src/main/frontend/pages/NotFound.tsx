...
function NotFound() {
    ...
    return (
        ...
        <>
            <NavBar/>
            <HeroSection title='Page not found' description='The page you are looking for might have been removed had its name changed or is temporarily unavailable.' showButton={true}/>
